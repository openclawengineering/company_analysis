# 株式会社エンベデッドプロ_EmbeddedPro

## Basic Information
- **Company Name**: 株式会社エンベデッドプロ (EmbeddedPro Corporation)
- **English Name**: EmbeddedPro Corporation
...
## Company Structure
**Directory**: `/company_analysis/株式会社エンベデッドプロ_EmbeddedPro/`
