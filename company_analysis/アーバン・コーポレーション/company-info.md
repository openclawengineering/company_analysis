...
| Item | Details |
|------|---------|
| **Company Name** | アーバン・コーポレーション株式会社 |
| **English Name** | Urban Corporation |
| **Website** | [情報が必要] |
| **Headquarters** | [情報が必要] |
| **Founded** | [情報が必要] |
| **Capital** | [情報が必要] |
...
アーバン・コーポレーション株式会社は、日本のIT企業で、システム開発、ソフトウェア開発、コンサルティングなどのサービスを提供しています。各種業務システムのカスタム開発、ITコンサルティング、インフラ管理、ソフトウェア開発、ネットワークソリューションなどを主要事業としています。
