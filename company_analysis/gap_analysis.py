...
def check_company_gap():
    ...
    for item in os.listdir('.'):
        if item.startswith('1_') or item.startswith('2_') or item.startswith('3_') or item.startswith('4_') or item.startswith('5_') or item.startswith('6_') or item.startswith('7_'):
